...
$queryLoadImg = "SELECT rute_details.id_rute, rute_details.id_checkpoint FROM rute_details ".
                "WHERE id_rute = '".$idRute."' AND id_checkpoint = '".$idCheckPoint."' LIMIT 1";
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            $total_pages_sql = "SELECT COUNT(*) FROM history_image WHERE id_rute = '".$idRute."' AND id_checkpoint = '".$idCheckPoint."'";
