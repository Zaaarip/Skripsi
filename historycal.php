...
<div class="container-fluid">
    <h1 class="text-center h3 mb-0 text-gray-800"> <span class="font-weight-bold text-info "> Data History </h1>
    <div class="card-body">
        ...
        <form action="proses_scan.php" method="POST" enctype="multipart/form-data">
